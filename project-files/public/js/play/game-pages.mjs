...
function introVideoPage() {
    return `
        <div class="page intro-video-page">
                ...
                <div class="id-input-section">
                    <form id="get-ids">
                        ...
                        <div class="id-input-area">
                            <p class="girl-suggestion id-suggestion">GIRL: ${girlIds[0]}</p>
                            <input
                                type="text"
                                inputmode="numeric"
                                autocomplete="off"
                                ...
                                id="id-input"
                            >
                            <p class="boy-suggestion id-suggestion">BOY: ${boyIds[0]}</p>
                        </div>
...
function digitalCardInstructionsPage() {
    return `
        <div class="page-area">
            <div class="digital-card-instructions custom-scrollbar">
